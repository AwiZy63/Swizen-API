...
module.exports = verifyEmail_html = (email, code) => {
  return `
  <!DOCTYPE html>
                                ...
                                <td style="padding-bottom:20px;padding-left:10px;padding-right:10px;padding-top:30px;">
                                  <div style="font-family: sans-serif">
                                    <div style="font-size: 12px; color: #393d47; line-height: 1.2; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif;">
                                      <p style="margin: 0; font-size: 12px; text-align: center;"><span style="font-size:38px;color:#333333;"><strong>Vérifiez votre email</strong></span></p>
                                    </div>
                                  </div>
                                </td>
                              </tr>
                                ...
                                <td style="padding-bottom:20px;padding-left:50px;padding-right:50px;padding-top:10px;">
                                  <div style="font-family: sans-serif">
                                    <div style="font-size: 14px; color: #393d47; line-height: 1.2; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif;">
                                      <p style="margin: 0; font-size: 13px; text-align: center;"><span style="font-size:13px;">Vous recevez ce mail car vous venez de vous inscrire sur le site de <strong>Swizen.eu</strong> avec l'adresse email : <strong><a href="mailto://${email}" target="_blank" style="text-decoration: underline; color: #0068a5;" rel="noopener"><u>${email}</u></a></strong></span></p>
                            ...
                            <table class="text_block" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                              <tr>
                                <td>
                                  <div style="font-family: sans-serif">
                                    <div style="font-size: 12px; color: #393d47; line-height: 1.2; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif;">
                                      <p style="margin: 0; font-size: 12px; text-align: center;"><span style="color:#333333;"><strong><span style="font-size:26px;"><span style="font-size:24px;">Votre code d'activation est :</span>&nbsp;</span></strong></span></p>
                                    </div>
                                  </div>
                                </td>
                              </tr>
                            ...
                            <table class="button_block" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                              <tr>
                                <td style="padding-bottom:10px;padding-left:10px;padding-right:10px;padding-top:30px;text-align:center;">
                                  <div align="center">
                                    <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://swizen.eu/verification?email=${email}&code=${code}" style="height:42px;width:227px;v-text-anchor:middle;" arcsize="12%" stroke="false" fillcolor="#0064cc"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#ffffff; font-family:Tahoma, Verdana, sans-serif; font-size:16px"><![endif]--><a href="https://swizen.eu/verification?email=${email}&amp;code=${code}" target="_blank" style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#0064cc;border-radius:5px;width:auto;border-top:0px solid #8a3b8f;border-right:0px solid #8a3b8f;border-bottom:0px solid #8a3b8f;border-left:0px solid #8a3b8f;padding-top:5px;padding-bottom:5px;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;"><span style="padding-left:20px;padding-right:20px;font-size:16px;display:inline-block;letter-spacing:normal;"><span style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;"><strong>ACTIVER MON COMPTE</strong></span></span></a>
                            ...
                            <table class="text_block" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                              <tr>
                                <td>
                                  <div style="font-family: sans-serif">
                                    <div style="font-size: 14px; color: #393d47; line-height: 1.2; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif;">
                                      <p style="margin: 0; font-size: 14px; text-align: center;"><span style="color:#a4a4a4;font-size:12px;">Le code est valide durant 15 minutes.</span><br><span style="color:#a4a4a4;font-size:12px;">Si le code est expiré, veuillez vous rendre sur ce lien :</span><br><span style="font-size:12px;"><a href="https://swizen.eu/verification" target="_blank" style="text-decoration: underline; color: #c5c5c5;" rel="noopener"><strong>RENVOYER UN CODE</strong></a></span></p>
